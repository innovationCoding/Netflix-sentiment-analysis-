...
TRAIN_DATA=os.path.abspath(os.path.join(root_path, 'F:/aiproject/model/train.txt'))  
TEST_DATA=os.path.abspath(os.path.join(root_path, 'F:/aiproject/model/test.txt')) 
