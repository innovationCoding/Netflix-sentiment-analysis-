...
WORD2IDX_PATH=os.path.abspath(os.path.join(root_path, "F:/aiproject/model/word2idx.txt"))

TRAIN_DATA=os.path.abspath(os.path.join(root_path, 'F:/aiproject/model/preprocessed_reviews.txt'))  
TEST_DATA=os.path.abspath(os.path.join(root_path, 'F:/aiproject/model/preprocessed_reviews_test.txt')) 

OUTPUT_DIR=os.path.abspath(os.path.join(root_path, 'F:/aiproject/model/tf/tf_records'))
